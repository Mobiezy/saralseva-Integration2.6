...
/**
 * Created by apple on 3/11/17.
 */

public class PayByPayUBiz {
    private Activity activity;
    private static PayByPayUBiz instance = null;
    ...
    private OneClickPaymentListener oneClickPaymentListener = new OneClickPaymentListener() {
    ...
    private PayByPayUBiz()
    {

    }

    public static PayByPayUBiz getInstance()
    {
        if(instance == null) {
            instance = new PayByPayUBiz();
        }

        return instance;
    }

    public void execute(Activity activity, String merchantKey, String firstName, String email, String amount)
    {
        this.activity = activity;

        //TODO Must write this code if integrating One Tap payments
        OnetapCallback.setOneTapCallback(oneClickPaymentListener);
        ...
        navigateToBaseActivity(this.activity, merchantKey, firstName, email, amount);
    }
    ...
    **/
    ...
    private int environment = PayuConstants.STAGING_ENV;
    ...
    public void navigateToBaseActivity(Activity activity, String merchantKey, String firstName, String email, String amount) {
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PayByPayUBiz.this.activity);
    ...
    private void fetchMerchantHashes(final Intent intent) {
        ...
        new AsyncTask<Void, Void, HashMap<String, String>>() {
            ...
            protected void onPostExecute(HashMap<String, String> oneClickTokens) {
                ...
                activity.startActivityForResult(baseActivityIntent, PayuConstants.PAYU_REQUEST_CODE);
            }
        }.execute();
    }
    ...
    public void launchSdkUI(PayuHashes payuHashes) {
        ...
        Intent intent = new Intent(this.activity, PayUBaseActivity.class);
    ...
    public void activityResult(int requestCode, int resultCode, Intent data){
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                ...
                Toast.makeText(this.activity, R.string.toast_pay_receive_error, Toast.LENGTH_LONG).show();
            }
        }
    }
}
